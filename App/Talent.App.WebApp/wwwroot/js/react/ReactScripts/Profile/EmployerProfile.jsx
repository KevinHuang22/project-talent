...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            //url: 'http://talentProfileService.azurewebsites.net/profile/profile/getEmployerProfile',//Profile
            url: 'http://talentProfileService.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'http://talentProfileService.azurewebsites.net/profile/profile/saveEmployerProfile',//Profile
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
